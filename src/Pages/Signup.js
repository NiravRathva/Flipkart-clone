        ...
        <div className=" flex mx-auto  lg:w-7/12 md:9/12 justify-center items-center my-8 h-[80vh]">
            <div className="w-2/6 bg-blue-600 h-5/6 hidden md:block">
                <div className="p-4 md:p-8">
                    <h1 className="text-white text-2xl md:text-3xl lg:text-4xl font-bold mb-4">Looks like you're new here</h1>
                    <p className="text-gray-400 text-md md:text-lg lg:text-xl font-bold mb-4">Signup with your Email to get started</p>
                </div>
            </div>
            {/* login form  */}
            <div className="w-4/6 bg-white h-5/6 p-3 ">
                <div className="p-4 md:p-8 lg:p-8">
                    <form action="">
                        ...
                        <button
                            className="w-full bg-orange-600 text-white py-2 px-4 rounded-md focus:outline-none my-4"
                            type="submit"
                        >
                            Continue
                        </button>
